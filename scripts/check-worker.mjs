...
assert.deepEqual(await (await worker.fetch(new Request('https://example.test/api/google-reviews'), env)).json(), { available: false });
console.log('PASS: Sites adapter rendering, static asset delegation and unconfigured reviews.');
